  ...
  <div class="w3-display-left w3-text-dark-grey" style="padding:48px">
    ...
    <p>
      <c:choose>
      	...
      	<c:otherwise>
      		<button class="w3-button w3-yellow w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off"  data-toggle="modal" data-target="#loginModal" >JOIN TO ASK</button>
      	</c:otherwise>
      </c:choose>
